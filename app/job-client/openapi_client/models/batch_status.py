...
class BatchStatus(BaseModel):
    """
    BatchStatus holds general information about batch status  # noqa: E501
    """
    ...
    __properties = ["batchName", "batchType", "created", "ended", "jobId", "jobStatuses", "message", "name", "started", "status"]
    ...
    @classmethod
    def from_json(cls, json_str: str) -> BatchStatus:
    ...
    @classmethod
    def from_dict(cls, obj: dict) -> BatchStatus:
        """Create an instance of BatchStatus from a dict"""
        if obj is None:
            return None

        if not isinstance(obj, dict):
            return BatchStatus.parse_obj(obj)

        _obj = BatchStatus.parse_obj({
